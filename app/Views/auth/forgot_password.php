        ...
        <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div
                ...
                <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                    ...
                    <a href="#" class="login-logo pb-xl-20 pb-15">
                        <img src="<?= base_url(); ?>/logo/logos.png" class="max-h-70px" alt="" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Signin-->
                        ...
                        <form class="form" id="kt_login_singin_form" action="<?= base_url('auth/forgot'); ?>"
                            ...
                            <div class="pb-5 pb-lg-15">
                                <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Forgotten Password
                                    ?</h3>
                                <p class="text-muted font-weight-bold font-size-h4">Enter your email to reset your Email
                                    or NIK HRIS</p>
                            </div>
                            <!--end::Title-->
                            <!--begin::Form group-->
            ...
            <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
                <div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom"
                    style="background-image: url(<?= base_url(); ?>/theme/dist/assets/media/svg/illustrations/login-visual-4.svg);">
                    <!--begin::Aside title-->
                    <h3
