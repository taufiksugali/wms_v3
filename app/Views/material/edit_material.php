		...
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="" class="text-muted">Edit Material</a>
                    </li>
                </ul>
				<!--end::Page Title-->
			</div>
                        ...
                        <form method="post" class="form" action="<?php echo base_url('material/update'); ?>">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger">*</span></label>
                                    <input type="text" name="material_weight" value="<?= $material_edit->material_weight ?>" class="form-control <?= ($validation->getError('material_weight')) ? 'is-invalid' : ''; ?>" placeholder="Enter weight" />
                                ...
                                <div class="form-group row">
                                    <div class="col-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" value="<?= $material_edit->material_length ?>" class="form-control numbers <?= ($validation->getError('material_length')) ? 'is-invalid' : ''; ?>" value="<?= old('material_length'); ?>" name="material_length" placeholder="Length"/>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" value="<?= $material_edit->material_width ?>" class="form-control numbers <?= ($validation->getError('material_width')) ? 'is-invalid' : ''; ?>" value="<?= old('material_width'); ?>" name="material_width" placeholder="Width"/>
                                            <div class="input-group-append">
                                                <span class="input-group-text">cm</span>
                                            </div>
                                    ...
                                    <div class="col-4">
                                        <label class="font-weight-bold">&nbsp;</label>
                                        <div class="input-group">
                                            <input type="text" value="<?= $material_edit->material_height ?>" class="form-control numbers <?= ($validation->getError('material_height')) ? 'is-invalid' : ''; ?>" value="<?= old('material_height'); ?>" name="material_height" placeholder="Height"/>
                                            <div class="input-group-append">
                                                <span class="input-group-text">cm</span>
                                            </div>
